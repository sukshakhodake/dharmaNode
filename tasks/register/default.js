...
module.exports = function(grunt) {
    grunt.registerTask('default', ['copy:assets','clean:backend', 'sass:backendDevelopment','copy:backendDevelopment', 'copy:jsBackendDevelopment', 'copy:backendDevelopment']);
