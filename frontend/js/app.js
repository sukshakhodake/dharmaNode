...
firstapp.config(function ($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider) {
    ...
    $stateProvider
        ...
        .state('fan-corner-play', {
            url: "/fan-corner-play/:id",
            templateUrl: "frontend/views/template.html",
            controller: 'FanCornerPlayCtrl'
        })
        .state('fan-corner-score', {
            url: "/fan-corner-score/:id",
            templateUrl: "frontend/views/template.html",
            controller: 'FanCornerScoreCtrl'
        })
        .state('fan-landing', {
            url: "/fan-landing",
            templateUrl: "frontend/views/template.html",
...
firstapp.filter('uploadpath2', function () {
    return function (input) {
        ...
        if (input) {
            if (input.indexOf('https://') == -1) {
                return "http://images.dharma-production.com/api/" + "download/" + input;
